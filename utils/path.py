...
LOGO_INRIA = os.path.join(BASE_DIR,"app_seg", "assets", "INRIA.png")
LOGO = os.path.join(BASE_DIR,"app_seg", "assets", "brain.png")
LOG_DIR = os.path.join(LOCAL,APP_NAME,"logs")
USER_GUIDE = os.path.join(BASE_DIR,"app_seg","USER_GUIDE.md")